import 'package:fitnesstracker/domain/user/diet/entities.dart';
...
class DietDetailsView extends StatefulWidget {
  final Diet diet;
  const DietDetailsView({super.key, required this.diet});
                    ...
                    Transform.scale(
                      ...
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: Image.network(widget.diet.image,
                              fit: BoxFit.fill),
                        ),
                      ),
                    ),
