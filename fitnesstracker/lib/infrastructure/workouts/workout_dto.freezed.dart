...
class _$_WorkoutDto implements _WorkoutDto {
  ...
  @override
  String toString() {
    return 'WorkoutDto(id: $id, title: $title, description: $description, duration: $duration, step: $step, focus: $focus, image1Url: $image1Url, image2Url: $image2Url)';
  }
...
abstract class _WorkoutDto implements WorkoutDto {
  const factory _WorkoutDto(
      ...
      required final String image2Url}) = _$_WorkoutDto;
